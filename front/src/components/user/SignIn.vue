      ...
      <form class="mt-8 space-y-6" action="#" method="POST">
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input id="nickname" name="nickname" type="text" autocomplete="email" required=""
...
<!--          </div>-->
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <button type="button" @click="toForgotPasswordPeople" class="font-medium hover:text-indigo-500">Forgot your password?</button>
          </div>
        </div>
